  ...
  return (
    ...
    >
      <section id="overview" className="project-content">
        ...
        <p>
          The app also includes an About page, which explains how it helps users easily track their tasks and progress, whether for personal goals, shopping lists, or other daily activities.
        </p>
      </section>
      ...
      <section id="design" className="project-content">
        <h2>Design</h2>
        <p>
          The interface is clean and minimal, focusing on clarity and ease of use. Navigation is quick and intuitive, and the layout adapts smoothly to both desktop and mobile. 
        </p>
        <p>
      ...
      <section id="reflection" className="project-content">
        <h2>Reflection</h2>
        <p>
          This project helped me strengthen my React skills and improve my understanding of component structure, state management, and responsive design.
        </p>
        <p>
